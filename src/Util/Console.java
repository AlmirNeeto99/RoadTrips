...
public class Console {
    ...
    /**
     * M̩todo Main que testa os demais metodos da classe Console. Este metodo ̩
     * apenas para testar o Console e nao deve ser modificado ou estendido!!!
     */
   /* 
    public static void main(String[] args) throws Exception{
        System.out.println("Esta classe ṇo deve ser modificada, voc̻ deve criar \n"
                + "outra classe para ser a sua aplica̤̣o, utilizando esta \n"
